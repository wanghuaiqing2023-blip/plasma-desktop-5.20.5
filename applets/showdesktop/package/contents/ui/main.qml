...
QtObject {
    ...
    Plasmoid.fullRepresentation: PlasmaCore.ToolTipArea {
        ...
        Layout.maximumWidth: inPanel && (plasmoid.location === PlasmaCore.Types.TopEdge || plasmoid.location === PlasmaCore.Types.BottomEdge) ? units.iconSizeHints.panel / 5 : -1
        Layout.maximumHeight: inPanel && (plasmoid.location === PlasmaCore.Types.LeftEdge || plasmoid.location === PlasmaCore.Types.RightEdge) ? units.iconSizeHints.panel / 5 : -1
